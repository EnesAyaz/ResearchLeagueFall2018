% State Variables
% Id, Ig, Vgsin, Vdsin
function [x7,x4,x3] = StateSpaceGaNBlockBottom(u1,u2,x1e,x7e,x4e,x3e,SampleTime) %Vgsso & Vdso & Idsold & Igold & Vgsold & Vdsold
...
%% Input Definition
    ...
    B(2,1) = x9/CC;
    A(2,1) = (x11+x9)/CC;
    A(3,1) = -1/x9 + (x11 + x9)*(x10+x9)/(x9*CC);
